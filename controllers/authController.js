...
const registerUser = async(req, res)=>{
    ...
    try{
        ...
        const transport = nodemailer.createTransport({
            ...
            secure: true,
            auth: {
            user: "glumytheinmortales@gmail.com",
            pass: "xuarcsbbdvmajoem"
            }
        });
        ...
        req.flash("mensajes", 
        [{msg: "Necesitás activar tu cuenta, por favor revisá tu correo electrónico y accede al link de confirmación que te hemos enviado. Aseguráte de revisar tu Correo no deseado."}])
